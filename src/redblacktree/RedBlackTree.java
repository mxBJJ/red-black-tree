...
public class RedBlackTree implements Tree{
    ...
    private void rightRotate(Node node){
        System.out.println("Nó " + node + " foi rotacionando para a direita.");
    ...
    private void leftRotate(Node node){
        System.out.println("Nó " + node + " foi rotacionando para a esquerda.");

        Node tempRightNode = node.getRightChild();
        node.setRightChild(tempRightNode.getRightChild());
